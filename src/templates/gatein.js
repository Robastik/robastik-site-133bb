...
export default class Post extends React.Component {
    render() {
        return (
          ...
          <script src={withPrefix('js/iframeSourceGateIn.js')} type="text/javascript" defer/>
          </Helmet>
            <div className="outer">
              <div className="inner-medium">
                <article className="post post-full">
                  ...
                  <div className="post-content">
                    ...
                    <iframe id="webapp" width="100%" height="120" frameborder="0" src="https://firebasestorage.googleapis.com/v0/b/robastik-2cb02.appspot.com/o/page%2Fpreloader.html?alt=media&token=be7ee1fb-8cca-493c-a552-8ea45a3b3e4a" seamless></iframe>
                  </div>
