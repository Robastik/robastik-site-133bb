...
Большинству пользователей необходимо решать свои рутинные задачи одной кнопкой. Вместо этого обычно предлагается многословная справка, неудачно переведенная с другого языка, которую часто можно заменить фразой "догадайся сам".

> Одна кнопка - решение одной задачи.

Почему же нет готовых решений для простых задач? 
