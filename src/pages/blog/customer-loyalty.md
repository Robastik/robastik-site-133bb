...
canonical_url: ''
---
Собрать в интернете информацию, проанализировать её и результаты изложить нормальным человеческим языком - так выглядит рабочий процесс анализа данных. В крупных проектах собирают и обрабатывают петабайты данных с помощью облачных кластеров, для других задач достаточно пары десятков строк в Excel.
