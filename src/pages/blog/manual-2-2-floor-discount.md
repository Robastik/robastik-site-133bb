...
---
В [первой части](https://robastik.ru/blog/manual-2-1-floor-discount/) иллюстрированной инструкции по проведению расчета величины скидки за первый и последний этаж был показан порядок сбора данных с сайтов объявлений силами Excel и первичный анализ собранных данных. Исходные данные разбиты по группам этажности 

![](/images/manual-2-2-floor-discount/001.png)
