...
canonical_url: ''
---
Высокие технологии постепенно становятся доступными рядовому потребителю, и анализ данных не является исключением. Культура data driven становится must have уже на уровне учебных проектов и рачительные домохозяйки делятся data driven insights в инстаграм.
