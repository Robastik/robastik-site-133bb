...
canonical_url: ''
---
Высокие технологии постепенно становятся доступными рядовому потребителю и анализ данных не является исключением. Культура data driven признается must have уже на уровне школьных проектов и рачительные домохозяйки делятся data driven insights в инстаграм. 

Excel укрепляет свои позиции как отраслевой стандарт

Поскольку каждый теперь должен data driven decision making
