...
Если выбор Excel как инструмента анализа достаточно очевиден, то в отношении сбора в интернете данных для анализа такой определенности нет. Собирать руками, отдавать на аутсорс или программировать самостоятельно - такой выбор предлагают сотни существующих продуктов. Data driven decision making не получается без данных ,
