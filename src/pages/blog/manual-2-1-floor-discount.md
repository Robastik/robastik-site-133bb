...
_Настройка инфраструктуры_ для нашего _кейса_ заключается в _конфигурировании_ Excel двумя надстройками. Надстройка [Power Query](https://en.wikipedia.org/wiki/Power_Query) предоставляет средства _[ETL](https://ru.wikipedia.org/wiki/ETL)_. Надстройка _[Робастик](https://robastik.ru/)_ предоставляет средства автоматизации.
