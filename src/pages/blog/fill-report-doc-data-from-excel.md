...
Сейчас в этом поле написано **В3**. Если в этом поле написать **Цена\_товара**, то ячейка **В3** будет получит название **Цена\_товара**. Вот так:![](file:///C:\Users\9EE3~1\AppData\Local\Temp\msohtmlclip1\01\clip_image005.jpg)
