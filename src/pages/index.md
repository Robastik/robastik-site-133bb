...
meta_description: >-
  Робастик - добавляет в меню кнопки для парсинга сайтов и заполнения документов
  по шаблону. Парсинг Авито и ЦИАН работает без дополнительной настройки сразу
