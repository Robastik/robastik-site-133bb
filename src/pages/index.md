...
sections:
  ...
  - section_id: more
    ...
    subtitle: >-
      для подготовки данных Excel к заполнению в Word справок, сводок, отчетов и
      других документов
    reviews:
  ...
  - section_id: recent-posts
    ...
    background: gray
    title: С чего начать
meta_title: 'Робастик | Парсинг и отчетинг в '
meta_description: >-
  Робастик - надстройка Excel добавляет в меню кнопки для парсинга сайтов и
  заполнения документов по шаблону. Парсинг Авито и ЦИАН работает без
