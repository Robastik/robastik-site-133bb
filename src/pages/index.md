...
sections:
  - section_id: hero
    ...
    content: >
      Добавьте в Excel автоматизацию: готовый парсинг сайтов недвижимости, заполнение шаблонных документов MS Word результатами анализа из Excel, отображение данных на карте и другие инструменты для оценщиков, консультантов и аналитиков
    actions:
